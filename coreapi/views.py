...
def dummy():
    ...
    Bank1LoanOffers(accountID=accountID1, category="personal", description="9.06%").save()
    Bank1LoanOffers(accountID=accountID1, category="home", description="6.7%").save()
    Bank1LoanOffers(accountID=accountID1, category="education", description="9.25%").save()
    Bank1LoanOffers(accountID=accountID2, category="personal", description="9.25%").save()
    Bank2LoanOffers(accountID=accountID2, category="home", description="6.9%").save()
    Bank2LoanOffers(accountID=accountID2, category="education", description="9.55%").save()
    Bank5LoanOffers(accountID=accountID5, category="education", description="10.05%").save()
    Bank5LoanOffers(accountID=accountID5, category="personal", description="9.50%").save()
    Bank5LoanOffers(accountID=accountID5, category="home", description="7.00%").save()
    print("[DONE]")
